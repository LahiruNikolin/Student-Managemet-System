...
$id=$_GET['id'];
//dd($id);
$teacher = DB::table('teacher')->where('tid',$id)->get();
        ...
        <div class="container">
            <form action="updateTeacher" method="POST">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" value="{{ $t->fname }}" class="form-control" id="inputFirstName" placeholder="First Name" name="fname">
                </div>
              </div>
              <div class="form-group row">
                <label for="inputLastName" class="col-sm-2 col-form-label">Last Name:</label>
                  <div class="col-sm-10">
                    <input type="text" value="{{ $t->lname }}" class="form-control" id="inputLastName" placeholder="Last Name" name="lname">
                  </div>
              </div>
              <div class="form-group row">
                <label for="inputEmail" class="col-sm-2 col-form-label">Email:</label>
                  <div class="col-sm-10">
                    <input type="email" value="{{ $t->email }}" class="form-control" id="inputEmail" placeholder="Email" name="email">
                  </div>
              </div>
              <div class="form-group row">
                <label for="inputAddress" class="col-sm-2 col-form-label">Address:</label>
                  <div class="col-sm-10">
                    <input type="address" value="{{ $t->address }}" class="form-control" id="inputAddress" placeholder="Address" name="address">
                  </div>
              </div>
              <div class="form-group row">
                <label for="inputAge" class="col-sm-2 col-form-label">Age:</label>
                  <div class="col-sm-10">
                    <input type="text" value="{{ $t->age }}" class="form-control" id="inputAge" placeholder="Age" name="age">
                  </div>
              </div>
              <div class="form-group row">
                <label for="inputQualification" class="col-sm-2 col-form-label">Qualification:</label>
                  <div class="col-sm-10">
                    <input type="text" value="{{ $t->qualification }}" class="form-control" id="inputQualification" placeholder="Qualification" name="qualification">
                  </div>
              </div>
              <div class="form-group row">
                <label for="inputJoinDate" class="col-sm-2 col-form-label">Join Date:</label>
                  <div class="col-sm-10">
                    <input type="date" value="{{ $t->joinDate }}" class="form-control" id="inputJoinDate" name="joinDate">
                  </div>
              </div>
              <div class="form-group row">
